...
function sendMail($email, $token){
	...
	$txt = "Xin chào. Đây là link kích hoạt của bạn: http://localhost/My%20Website%20Mark%20III/verify-email.php?token=$token. Bấm vào đường link để kích hoạt tài khoản.";
